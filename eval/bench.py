...
CONFIGS = [
    ...
    {"label": "local qwen3:1.7b ollama small", "host": "localhost", "port": 11434,
     "scheme": "http", "key_env": None, "path": "/v1/chat/completions",
     "model": "qwen3:1.7b", "extra": {"reasoning_effort": "none"}, "runs": 3},
    {"label": "local qwen3:0.6b ollama small", "host": "localhost", "port": 11434,
     "scheme": "http", "key_env": None, "path": "/v1/chat/completions",
     "model": "qwen3:0.6b", "extra": {"reasoning_effort": "none"}, "runs": 3},
    {"label": "local gemma3:270m ollama", "host": "localhost", "port": 11434,
     "scheme": "http", "key_env": None, "path": "/v1/chat/completions",
     "model": "gemma3:270m", "extra": {}, "runs": 3},
    {"label": "local gemma3:1b ollama", "host": "localhost", "port": 11434,
     "scheme": "http", "key_env": None, "path": "/v1/chat/completions",
     "model": "gemma3:1b", "extra": {}, "runs": 3},
    {"label": "local gemma3:4b ollama", "host": "localhost", "port": 11434,
     "scheme": "http", "key_env": None, "path": "/v1/chat/completions",
     "model": "gemma3:4b", "extra": {}, "runs": 3},
    {"label": "local granite4:micro ollama", "host": "localhost", "port": 11434,
     "scheme": "http", "key_env": None, "path": "/v1/chat/completions",
     "model": "granite4:micro", "extra": {}, "runs": 3},
    {"label": "local granite4:micro-h ollama", "host": "localhost", "port": 11434,
     "scheme": "http", "key_env": None, "path": "/v1/chat/completions",
     "model": "granite4:micro-h", "extra": {}, "runs": 3},
    {"label": "local granite3.3:2b ollama", "host": "localhost", "port": 11434,
     "scheme": "http", "key_env": None, "path": "/v1/chat/completions",
     "model": "granite3.3:2b", "extra": {}, "runs": 3},
    {"label": "local granite3.3:8b ollama", "host": "localhost", "port": 11434,
     "scheme": "http", "key_env": None, "path": "/v1/chat/completions",
     "model": "granite3.3:8b", "extra": {}, "runs": 3},
    ...
    {"label": "llamacpp qwen3.5-4b", "host": "localhost", "port": 8091,
     "scheme": "http", "key_env": None, "path": "/v1/chat/completions",
     "model": "qwen3.5-4b",
     "extra": {"chat_template_kwargs": {"enable_thinking": False}}, "runs": 3},
